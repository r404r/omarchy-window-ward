...
- 兼容目标：Omarchy 4.0.4 / Hyprland 0.56.2；0.4.2 候选发布前仍须独立完成官方安装与真实运行验收。
...
从 0.4.1 或更高版本降级前，请先运行当前版本的 `scripts/uninstall`；0.4.0 的卸载器无法识别新版双快捷键受管理块。之后再安装旧版本并重新运行其 setup。
