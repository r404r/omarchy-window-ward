...
[[ $(grep -Fc 'hl.unbind("SUPER + W")' "$tmp/bindings.lua") == 1 ]]
[[ $(grep -Fc 'hl.unbind("SUPER + Q")' "$tmp/bindings.lua") == 1 ]]
[[ $(grep -Fc 'o.bind("SUPER + W", "Close window safely"' "$tmp/bindings.lua") == 1 ]]
[[ $(grep -Fc 'o.bind("SUPER + Q", "Close window safely"' "$tmp/bindings.lua") == 1 ]]
